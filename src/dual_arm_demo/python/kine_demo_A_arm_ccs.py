...
logger.setLevel(logging.INFO)      # 不再打印 DEBUG
logger.setLevel(logging.DEBUG)   # 想开再打开
...
'''
ini_result=kk.load_config("/home/look/文档/TJ_FX_ROBOT_CONTRL_SDK-master/TJ_FX_ROBOT_CONTRL_SDK-master/demo_linux_win/python/ccs_m6.MvKDCfg")
time.sleep(0.5)
# print(ini_result)
...
print("zheng jie :",fk_mat)
pose_6d_1=kk.mat4x4_to_xyzabc(fk_mat)
print("guan jie jiao",pose_6d_1)

#逆解
ik_result_structure=kk.ik(robot_serial=0,
                          pose_mat=fk_mat,
                          ref_joints=[10,10,10,10,10,10,10])
...
ik_nsp_result_structure=kk.ik_nsp(robot_serial=0,
                                  pose_mat=fk_mat,
                                  ref_joints=[10,10,10,10,10,10,10],
                                  zsp_type=0,
...
tag_movl=kk.movL(robot_serial=0,
                 start_xyzabc=pose_6d_1,
                 end_xyzabc=pose_6d_2,
                 ref_joints=[10,10,10,10,10,10,10],
                 vel=100,acc=100,
                 save_path='test.txt')
time.sleep(0.5)
